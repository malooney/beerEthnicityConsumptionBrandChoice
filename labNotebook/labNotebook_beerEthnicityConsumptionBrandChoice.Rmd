...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.CHICAGO[30:129]), collapse=" + ")
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.DALLASTX[30:79]), collapse=" + ")
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.LOSANGELES[30:79]), collapse=" + ")
