...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.CHICAGO[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.CHICAGO[[1]]))
...
stargazer(D8.2010_aggregate_data.CHICAGO[[1]][,10:19], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.DALLASTX[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.DALLASTX[[1]]))
...
stargazer(D8.2010_aggregate_data.DALLASTX[[1]][,10:19], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.LOSANGELES[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.LOSANGELES[[1]]))
...
stargazer(D8.2010_aggregate_data.LOSANGELES[[1]][,10:19], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  if(!file.exists(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.SPOKANE.rds", sep=""))) {

    stop("file does not exist in project directory.")

  } else{

  D8.2010_aggregate_data.SPOKANE  <- readRDS(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.SPOKANE.rds", sep=""))

  }

  lm.Brands <- paste(colnames(D8.2010_aggregate_data.SPOKANE[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.SPOKANE[[1]]))
...
stargazer(D8.2010_aggregate_data.SPOKANE[[1]][,10:19], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  if(!file.exists(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.SYRACUSE.rds", sep=""))) {

    stop("file does not exist in project directory.")

  } else{

  D8.2010_aggregate_data.SYRACUSE  <- readRDS(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.SYRACUSE.rds", sep=""))

  }

  lm.Brands <- paste(colnames(D8.2010_aggregate_data.SYRACUSE[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.SYRACUSE[[1]]))
...
# Load Data -------------------------------------------------------------------
  ...
  if(!file.exists(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.HOUSTON.rds", sep=""))) {

    stop("file does not exist in project directory.")

  } else{

  D8.2010_aggregate_data.HOUSTON  <- readRDS(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D8.2010_aggregate_data.HOUSTON.rds", sep=""))

  }

  lm.Brands <- paste(colnames(D8.2010_aggregate_data.HOUSTON[[1]][32:81]), collapse=" + ")

  model.lm.Brands <- formula(paste("log(share) - log(outshr)~  0 + p2_Wmean +",
                         lm.Brands, sep=""))

  summary(lm.results <- lm( model.lm.Brands,
                          data= D8.2010_aggregate_data.HOUSTON[[1]]))
...
budLight_Chicago <- dplyr::filter(D8.2010_aggregate_data.CHICAGO[[1]], 
                           Brand=="BUD LIGHT")

budLight_DallasTx <- dplyr::filter(D8.2010_aggregate_data.DALLASTX[[1]], 
                           Brand=="BUD LIGHT")

budLight_Houston <- dplyr::filter(D8.2010_aggregate_data.HOUSTON[[1]], 
                           Brand=="BUD LIGHT")

budLight_LosAngeles <- dplyr::filter(D8.2010_aggregate_data.LOSANGELES[[1]], 
                           Brand=="BUD LIGHT")

budLight_Spokane <- dplyr::filter(D8.2010_aggregate_data.SPOKANE[[1]], 
                           Brand=="BUD LIGHT")

budLight_Syracuse <- dplyr::filter(D8.2010_aggregate_data.SYRACUSE[[1]], 
                           Brand=="BUD LIGHT")
...
ivs_Hausman <- data.frame( 
  D8.2010_aggregate_data.CHICAGO[[1]]['Brand'],
  D8.2010_aggregate_data.CHICAGO[[1]]['p2_Wmean_non_pr'], 
  D8.2010_aggregate_data.DALLASTX[[1]]['p2_Wmean_non_pr'], 
  D8.2010_aggregate_data.HOUSTON[[1]]['p2_Wmean_non_pr'], 
  D8.2010_aggregate_data.SPOKANE[[1]]['p2_Wmean_non_pr'], 
  D8.2010_aggregate_data.SYRACUSE[[1]]['p2_Wmean_non_pr']
)


colnames(ivs_Hausman) <- c("Brand", "z1_P_Chicago", "z2_P_DallasTx",
...
constant <- data.frame(constant= 
  matrix( 
    rep(1, 
        nrow(D8.2010_aggregate_data.LOSANGELES[[1]])), 
    ncol=1
    )
  )

beerLA.data <- D8.2010_aggregate_data.LOSANGELES[[1]][, c(1, 7, 12, 14, 16, 
                                                          32:81)]

beerLA.data <- cbind(constant, beerLA.data)

beerLA.data <- cbind(beerLA.data, ivs_Hausman[,2:6])

tmp_beerLA.data <- D8.2010_aggregate_data.LOSANGELES[[1]][, c(13, 17, 18, 19, 
                                                              23, 24)]

beerLA.data <- cbind(beerLA.data, tmp_beerLA.data)

rm(constant, ivs_Hausman, tmp_beerLA.data)
...
```{r, echo=FALSE, cache=F, message=F, warning=F}
  ...
  iv_lm.Brands <- paste(colnames(beerLA.data[7:56]), collapse=" + ")

  iv_lm.ivs <- paste(colnames(beerLA.data[c(58:59)]), collapse=" + ")
...
summary( iv.simple.logit <- ivreg( model.iv_lm.Brands,
  ...
  iv_lm.char <- paste(colnames(beerLA.data[62:67]), collapse=" + ")

  iv_lm.ivs <- paste(colnames(beerLA.data[58:59]), collapse=" + ")
...
Xlin = paste(colnames(beerLA.data[c(4, 7:56)]), sep="")
} else {
# Xlin = c("constant",
#          "price",
#          "sugar",
#          "mushy")
Xlin = paste(colnames(beerLA.data[c(4, 62:67)]), sep="")
}

Xrandom = paste(colnames(beerLA.data[c(1, 4, 62:67)]), sep="")

if(MDE==TRUE){
  
Xexo =  paste(colnames(beerLA.data[c(7:56)]), sep="")
} else {
Xexo =  paste(colnames(beerLA.data[c(62:67)]), sep="")
}
instruments = paste(colnames(beerLA.data[58:59]), sep="")
