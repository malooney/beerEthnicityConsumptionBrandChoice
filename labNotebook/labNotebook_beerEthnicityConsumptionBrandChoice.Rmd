...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.CHICAGO[[1]][31:80]), collapse=" + ")
...
stargazer(D8.2010_aggregate_data.CHICAGO[[1]][,10:18], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.DALLASTX[[1]][31:80]), collapse=" + ")
...
stargazer(D8.2010_aggregate_data.DALLASTX[[1]][,10:18], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.LOSANGELES[[1]][31:80]), collapse=" + ")
...
stargazer(D8.2010_aggregate_data.LOSANGELES[[1]][,10:18], 
          summary=T, 
          type="latex", 
...
# Load Data -------------------------------------------------------------------
  ...
  lm.Brands <- paste(colnames(D8.2010_aggregate_data.SPOKANE[[1]][31:80]), collapse=" + ")
...
stargazer(D8.2010_aggregate_data.SPOKANE[[1]][,10:18], 
          summary=T, 
          type="latex", 
