...
D6.treeStudy_2010_CHICAGO <- readRDS(paste(path.local, "/data_beerEthnicityConsumptionBrandChoice/D6.treeStudy_2010_CHICAGO.rds", sep=""))

print(D6.treeStudy_2010_CHICAGO, limit=NULL)
